  ...
  if (meta) {
    ...
    if (rep) {
      ...
      if (!rep.npm){
        ...
        context.repository = getRepo(rep.repo, meta);
      }
      if (rep.install) {
      ...
      if (rep.skip_tests) {
        context.module.skip_tests = rep.skip_tests;
      }
      if (rep.clone_repo) {
        context.module.clone_repo = rep.clone_repo;
        context.module.repo = rep.repo;
        context.module.branch = rep.branch;
      }
