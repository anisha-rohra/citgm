...
function grabGitRepository(context, next) {
  ...
  const proc = spawn('git', ['clone', context.repository, context.module.name], options);
  ...
  proc.on('close', function(code) {
    ...
    context.emit('data', 'info', context.module.name + ' git:',
        'git clone -b ' + context.module.branch + ' ' + context.module.repo + ' into ' + context.module.name);
